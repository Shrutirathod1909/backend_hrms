...
exports.getMyMenu = async (req, res) => {
  try {
    ...
    const modulesCsv = roleModuleResult.recordset[0]?.modules || "";
    const submodulesCsv = roleModuleResult.recordset[0]?.submodules || "";
    ...
    console.log("SUBMODULE CSV:", submodulesCsv);
    console.log("ALLOWED:", allowedSubmodules);
    const modulesQuery = `
